...
class AudioPanel(QWidget):
    def __init__(
        ...
        config_box = QGroupBox("Audio Engine")
        ...
        form.addRow("Block Size", self.buffer_size_input)
        form.addRow("Track Channel", self.channel_input)
        root.addWidget(config_box)

        buttons_box = QGroupBox("Engine Controls")
        ...
        self.startup_sound_note_label = QLabel("Default is 0.12 volume, capped at 0.20 for a quiet startup cue.")
