...
class MixerPanel(QWidget):
    def __init__(
        ...
        self.strip_scroll.setMinimumHeight(218)
        self.strip_scroll.setObjectName("mixerStripScroll")
        strip_host = QWidget()
        ...
        self.strip_scroll.setWidget(strip_host)
        strip_layout.addWidget(self.strip_scroll)
        ...
        self.chain_list.setMinimumHeight(126)
        self.chain_list.setMaximumHeight(178)
        self.error_label = QLabel("Error: ")
        self.effect_macro_box = QGroupBox("Smart Controls")
        self.effect_macro_box.setMaximumHeight(128)
