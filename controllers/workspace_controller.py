...
class WorkspaceController:
    ...
    def ingest_mixer_state(self, mixer_vm: MixerViewModel) -> None:
        ...
        if mixer_vm.insert_chain:
            ...
            managed = first.managed_instance_id or "none"
            ...
            self._vm.selected_runtime_handle_summary = (
                ...
                f"{first.managed_instance_loader_strategy or 'default_loader'}:"
                f"{first.managed_instance_validator_path or 'default_validator'}:"
                f"{first.managed_instance_failure_attribution or 'none'}:"
