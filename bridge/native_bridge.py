...
class NativeBridgeClient(BridgeClient):
    ...
    def __init__(self) -> None:
        ...
        self._plugin_registry_cache: list[PluginRegistryEntry] = [
            ...
            PluginRegistryEntry(
                plugin_id="midas.reverb.silenus",
            ...
            PluginRegistryEntry(
                plugin_id="midas.drive.inferno",
                name="MIDAS Inferno Drive",
                category="Saturation",
                vendor="MIDAS Labs",
                available=True,
                source="builtin",
            ...
            PluginRegistryEntry(
                plugin_id="midas.delay.hermes",
                name="MIDAS Hermes Echo",
                category="Delay",
                vendor="MIDAS Labs",
                available=True,
                source="builtin",
            ...
            PluginRegistryEntry(
                plugin_id="midas.stereo.aegean",
                name="MIDAS Aegean Width",
                category="Imaging",
                vendor="MIDAS Labs",
                available=True,
                source="builtin",
            ...
            PluginRegistryEntry(
                plugin_id="midas.filter.oracle",
                name="MIDAS Oracle Filter",
                category="Filter",
                vendor="MIDAS Labs",
                available=True,
                source="builtin",
            ...
            PluginRegistryEntry(
                plugin_id="midas.lofi.daedalus",
                name="MIDAS Daedalus LoFi",
                category="LoFi",
                vendor="MIDAS Labs",
                available=True,
                source="builtin",
            ...
            PluginRegistryEntry(
                plugin_id="midas.mod.nereid",
                name="MIDAS Nereid Chorus",
                category="Modulation",
                vendor="MIDAS Labs",
                available=True,
                source="builtin",
            ...
            PluginRegistryEntry(
                plugin_id="midas.utility.hermes",
                name="MIDAS Hermes Gain",
                category="Utility",
                vendor="MIDAS Labs",
                available=True,
                source="builtin",
            ...
            PluginRegistryEntry(
                plugin_id="midas.midi.oracle_chords",
                name="MIDAS Oracle Chords",
    ...
    def get_runtime_status(self) -> RuntimeStatus:
        ...
        return RuntimeStatus(
            ...
            catalog_source_label=str(values.get("catalog_source_label", "")),
            catalog_source_version=str(values.get("catalog_source_version", "")),
            catalog_descriptor_count=_as_int("catalog_descriptor_count", 0),
            catalog_valid_descriptor_count=_as_int("catalog_valid_descriptor_count", 0),
            catalog_policy_supported_descriptor_count=_as_int(
            ...
            for item in raw:
                ...
                slots.append(
                    InsertedPluginSlot(
                        ...
                        managed_instance_backend_name=str(values.get("managed_instance_backend_name", "")),
                        managed_instance_backend_handle=str(values.get("managed_instance_backend_handle", "")),
                        managed_instance_handle_state=str(values.get("managed_instance_handle_state", "unavailable")),
                        managed_instance_terminal=str(values.get("managed_instance_terminal", "false")).lower() == "true",
                        managed_instance_retryable=str(values.get("managed_instance_retryable", "true")).lower() == "true",
                        managed_instance_reason_source=str(values.get("managed_instance_reason_source", "none")),
                        managed_instance_loader_strategy=str(values.get("managed_instance_loader_strategy", "default_loader")),
                        managed_instance_validator_path=str(values.get("managed_instance_validator_path", "default_validator")),
                        managed_instance_failure_attribution=str(values.get("managed_instance_failure_attribution", "none")),
